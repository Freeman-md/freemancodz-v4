  ...
  return (
    <>
      ...
      <section className="border-y border-line bg-surface">
        <div className="container section">
          <SectionHeader
            ...
            copy="Curated proof across AI product systems, automation workers, fintech, and study-abroad platforms."
          />
      ...
      <section className="container section">
        <SectionHeader
          title="Other Project"
          copy="A supporting system aligned with backend reliability, automation, and self-healing operations direction."
        />
